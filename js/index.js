const latin_alphabets = ["a", "ã", "ǎ", "b", "b́", "ç", "d", "d̬", "ḍ", "e", "ë", "f", "g", "ǵ", "g̈", "h", "i", "j", "j́", "j̈", "k", "l", "m", "n", "ň", "o", "p", "r", "ř", "s", "ẗ", "t", "u", "w", "y", "z"]
const perso_arabic_alphabets = ["اَ", "آ", "ع", "ب", "ٻ", "چ", "د", "ڏ", "ڊ", "اے", "ئي", "ف", "گ", "ڳ", "ڱ", "ھ/ح", "آئَي / اِ", "ج", "ڄ", "ڃ", "ق/ڪ", "ل", "م", "ن", "ڻ", "او", "پ", "ر", "ڙ", "س/ص/ث", "ت/ط", "ٽ", "اُو / اُ", "و", "ي", "ز/ذ/ض/ظ"]

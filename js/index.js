latin_alphabets = ["a", "◌̃", "ä", "ǎ", "b", "b́", "b̌", "ç", "ç̌", "d", "d̈", "d̬", "ḍ", "d̤", "e", "ë", "f", "g", "ǧ", "ǵ", "g̈", "h", "i", "j", "ǰ", "j́", "j̈", "k", "ǩ", "l", "m", "n", "ň", "o", "p", "p̌", "r", "ř", "s", "š", "ẗ", "t̑", "t", "t̆", "ù", "u", "w", "y", "z"]
perso_arabic_alphabets = ["اَ", "آ", "اَي", "ع", "ب", "ٻ", "ڀ", "چ", "ڇ", "د", "ڌ", "ڏ", "ڊ", "ڍ", "اے", "ئي", "ف", "گ", "گھ", "ڳ", "ڱ", "ھ/ح", "آئَي / اِ", "ج", "جھ", "ڄ", "ڃ", "ق/ڪ", "ک/خ", "ل", "م", "ن", "ڻ", "او", "پ", "ڦ", "ر", "ڙ", "س/ص/ث", "ش", "ت/ط", "ٿ", "ٽ", "ٺ", "ُا", "اُو", "و", "ي", "ز/ذ/ض/ظ"]

cols = 8
rows = ((latin_alphabets.length + perso_arabic_alphabets.length) / cols) + .75;
